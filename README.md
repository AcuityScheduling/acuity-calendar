...
| disableCurrentTimeIndicator | `bool`                       | `false`       | Disables the current time indicator rendered                                                                                |
...
| Prop                        | Type                                         | Default value  | Description                                                                                                                                                                                           |
| --------------------------- | -------------------------------------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| disableCurrentTimeIndicator | `bool`                                       | `false`        | Disables the horizontal current time indicator in the calendar. Useful if a TimeGrid view represents multiple timezones across different column and a "current time" does not make sense to show      |
| events                      | `array`                                      | `[]`           | Array of [Events](#event)                                                                                                                                                                             |
| firstDay                    | `number`                                     | `0`            | Must be one of `[0, 1, 2, 3, 4, 5, 6]`. The first day of the week in numerical form, starting with Sunday as `0`                                                                                      |
