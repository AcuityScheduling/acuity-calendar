          ...
          (vn.calendar = function(e, t, n) {
            ...
            (vn.monthsRegex = function(e) {
              return this._monthsParseExact
                ...
                : (_(this, '_monthsRegex') || (this._monthsRegex = Fe),
        ...
        function M(e, t, a) {
          ...
          function D() {
            ...
            if (((r = arguments), (s = this), (u = e), n)) {
              if (void 0 === d)
                return (function(e) {
                  return (l = e), (d = setTimeout(Y, t)), _ ? M(e) : o;
                })(u);
	...
	*/
    ...
    function(e, t, n) {
      ...
      var P = function(e) {
        ...
        C = { 5: 22, 10: 27, 15: 31, 20: 34, 30: 42, 60: 65 },
        z = function(e) {
      ...
      var Q = function(e) {
        ...
        se = function(e) {
          var t = e.stepMinutes,
            n = e.selectMinutes;
          return (e.stepHeight || C[t]) / (t / n) + 1 / (60 / n);
        };
      function ie(e) {
        for (var t = 1; t < arguments.length; t++) {
          var n = null != arguments[t] ? arguments[t] : {},
      ...
      var me = function(e) {
          return e.reduce(function(e, t) {
            ...
            if (((e = [].concat(_e(e), [a])), 0 === r)) return e;
            for (var s = 1; s <= r; s += 1) {
        ...
        he = function(e) {
          var t = e.event,
            ...
            l = i * r + o;
          l > u && (l = u);
          var _ = fe({ event: t, pixelsPerMinute: r }),
            c = {
              height: l,
              top: d,
            ...
            Object.keys(a).reduce(function(e, t) {
              return (
                Object.keys(a[t]).forEach(function(n) {
                  e[n] = j([].concat(ye(l()(e, n, [])), ye(a[t][n])));
                }),
                e
              );
            }, {})
      ...
      var Ne = function(e, t) {
        ...
        Je = function(e) {
          var t = e.children,
            ...
            l = Ce(Object(a.useReducer)(Ne, Ie), 2),
            _ = l[0],
            c = l[1],
            m = n.width,
            h = n.height,
              ...
              Y
                ? Y.map(function(e) {
                    ...
                    return r.a.createElement(
                      ...
                      e.map(function(e) {
                        v += 1;
                        var n = l()(c, e.date.format('YYYY-MM-DD'), []);
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              ...
              (function() {
                for (
                  var e = ''.concat((s || C[n]) + 1 / w, 'px'), t = [], a = 0;
                  a < 24 * w;
                  a += 1
                ) {
                  var i = a % w;
            ...
            r.a.createElement(
              ...
              (function() {
                for (var e = w * (s || C[n]), t = [], a = 0; a < 24; a += 1)
                  t.push(
                    r.a.createElement(
                      'div',
                      {
        ...
        bt = function(e) {
          ...
          return (
            ...
            r.a.createElement(
              ...
              r.a.createElement('div', { className: Dt, style: { height: _ } }),
              t
                ? t(n)
                : r.a.createElement(
                    'div',
      ...
      var St = function(e) {
        ...
        Ht = function(e) {
          var t = e.event,
            ...
            E = x[0],
            O = x[1],
            P = se({ stepHeight: _, stepMinutes: n, selectMinutes: s }),
            W = re({
              originalStart: t.start,
              originalEnd: t.end,
              pixelsMoved: h.y,
          ...
          return (
            ...
            void 0 !== t.paddingTopStart &&
              (C.paddingTopStart = z.paddingTopStart),
            void 0 !== t.paddingBottomEnd &&
              (C.paddingBottomEnd = z.paddingBottomEnd),
            ((C = c({
              event: C,
              start: z.start,
              end: z.end,
            ...
            (function() {
              ...
              var e = (function(e) {
                ...
                return r;
              })({ columnMoves: R, columnWidths: i, columnIndex: o });
              e !== L && Y(e);
              var t = e + D;
              M < e && 0 !== E && A({ direction: -1, left: e }),
                M > t && E !== i.length - 1 && A({ direction: 1, left: e });
            })(),
            r.a.createElement(
              a.Fragment,
              null,
        ...
        return (
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              'span',
              null,
              t({ isExtending: _, extendedEvent: g })
            )
          )
        );
      };
      ...
      var Rt = r.a.forwardRef(function(e, t) {
        var n = e.columnId,
          s = e.columnIndex,
          i = e.columnWidths,
          o = e.currentTime,
          ...
          C = A.selectRangeHandlers,
          z = A.isSelectRangeFinished,
          G = A.resetSelectRangeDrag,
          U = A.selectRangeHeight,
          q = A.selectRangeTop,
          B = A.selectRange,
      ...
      (Ct.defaultProps = { minWidth: 190, minWidthEmpty: 100 }),
        (Ct.propTypes = {
          children: i.a.node.isRequired,
          date: je.isRequired,
          minWidth: i.a.number,
            ...
            r.a.createElement(gt, {
              ...
              renderHeader: function() {
                ...
                return A.map(function(n) {
                  var s = Nt({ events: R, groupId: n, selectedDate: t }),
              ...
              renderColumns: function(e) {
                ...
                return A.map(function(e, o) {
                  var d = Nt({ events: R, groupId: e, selectedDate: t }) || {},
                    _ = Nt({ events: W, groupId: e, selectedDate: t }) || [];
                  return r.a.createElement(At, {
                    ref: S(e),
        ...
        return r.a.createElement(gt, {
          ...
          renderHeader: function() {
            return H.map(function(e) {
              var n = Object.keys(l()(C, e.format('YYYY-MM-DD'), {})).length;
              return r.a.createElement(
                zt,
                {
          ...
          renderColumns: function(e) {
            ...
            return H.map(function(e, a) {
              var s = l()(A, e.format('YYYY-MM-DD'), []),
                d = l()(C, e.format('YYYY-MM-DD'), {}),
      ...
      var Zt = Le.month,
        ...
        en = function(e) {
          var t,
            ...
            a = e.view,
            r = e.firstDay,
            s = Gt({ firstDay: r, date: n });
          return (Kt((t = {}), Zt, n.format('MMMM YYYY')),
          Kt(t, Xt, 'Week of '.concat(s[0].format('MMMM D, YYYY'))),
          Kt(t, Qt, n.format('dddd, MMMM D, YYYY')),
          t)[a];
        };
      function tn(e, t) {
        return (
      ...
      var nn = function(e) {
          var t = e.cursorDate,
            ...
            _ = an({
              selectedDate: o,
              startDate: d()(new Date(u)),
              endDate: d()(new Date(l)),
              monthPadding: r,
            });
          if (!!_.fullRange)
            return (
              i({
                start: new Date(_.fullRange.start),
                end: new Date(_.fullRange.end),
              }),
              a({
                fetchMoreRange: {
                  start: new Date(_.fetchMoreRange.start),
                  end: new Date(_.fetchMoreRange.end),
                },
                fullRange: {
                  start: new Date(_.fullRange.start),
                  end: new Date(_.fullRange.end),
          ...
          if (un({ selectedDate: o, startDate: u, endDate: l })) {
            var c = ln({ selectedDate: o, monthPadding: r });
            return i({ start: new Date(c.start), end: new Date(c.end) }), s(c);
          }
          return null;
        },
        an = function(e) {
          ...
          return (
            rn({ selectedDate: t, startDate: n, monthPadding: r }) &&
              (s = sn({ startDate: n, endDate: a, monthPadding: r })),
            on({ selectedDate: t, endDate: a, monthPadding: r }) &&
              (s = dn({ startDate: n, endDate: a, monthPadding: r })),
            s
          );
        },
        rn = function(e) {
        ...
        fn = function(e) {
          var t = e.children,
            n = e.firstDay,
            a = e.fetchEventPadding,
            s = e.onNavigate,
            i = e.onFetchMoreEvents,
            o = e.onResetEventRange,
            u = e.onViewChange,
            l = e.selectedDate,
            _ = e.view,
            c = _n({ cursorDate: l, monthPadding: a }),
            m = function(e) {
              s(e), c({ onFetchMore: i, onResetRange: o });
            },
            h = en({ date: d()(l), view: _, firstDay: n }),
            f = function() {
              var e = new Date(
                $t({ view: _, direction: 1, currentDate: d()(l) })
              );
              m(e);
            },
            p = function() {
          ...
          return t
            ...
            : r.a.createElement(
                ...
                r.a.createElement(
                  'div',
                  { className: Ye('toolbar__navigate') },
                  r.a.createElement(
                    'button',
                    { type: 'button', onClick: M },
                    'Today'
                  ),
                  r.a.createElement(
                    'button',
                ...
                r.a.createElement('h1', { className: Ye('toolbar__title') }, h)
              );
        };
      (fn.defaultProps = {
        children: null,
        firstDay: 0,
        fetchEventPadding: 1,
        onFetchMoreEvents: function() {
          return null;
        },
        onResetEventRange: function() {
          return null;
        },
      }),
        (fn.propTypes = {
          ...
          firstDay: He,
          onFetchMoreEvents: i.a.func,
          onNavigate: i.a.func.isRequired,
          onResetEventRange: i.a.func,
          onViewChange: i.a.func.isRequired,
          selectedDate: Se.isRequired,
          view: xe.isRequired,
        });
      var pn = fn;
      function Mn(e, t, n) {
      ...
      var gn = function(e) {
        var t,
          n = e.events,
          a = (e.fetchEventPadding, e.firstDay),
          s = e.forceSixWeeks,
          i = e.minWidthColumn,
          o = e.minWidthColumnEmpty,
          u = e.onDragEnd,
          l = e.onExtendEnd,
          _ = e.onFetchMoreEvents,
          c = e.onNavigate,
          m = e.onSelectMore,
          h = e.onSelectDate,
          f = e.onSelectEvent,
          ...
          y = e.onResetEventRange,
          g = e.onSelectSlot,
          L = e.onViewChange,
          Y = e.renderCell,
          v = (e.renderEvent, e.renderCorner),
          D = e.renderEventPaddingBottom,
          k = e.renderEventPaddingTop,
          b = e.renderGroupsHeader,
          w = e.renderMonthHeader,
          T = e.renderSelectRange,
          S = e.renderSelectSlotIndicator,
          H = e.renderStepDetail,
          j = e.renderWeekHeader,
          x = e.renderDayGridEvent,
          E = e.renderTimeGridEvent,
          O = e.renderToolbar,
          P = e.selectedDate,
          W = e.selectMinutes,
          R = e.stepDetails,
          ...
          B = (Mn(
            (t = {}),
            N,
            r.a.createElement(pt, yn({ renderHeader: w }, U, G))
          ),
          Mn(t, I, r.a.createElement(Bt, yn({ renderHeader: j }, q, G))),
          Mn(t, J, r.a.createElement(Jt, yn({ renderHeader: b }, q, G))),
          t);
        return r.a.createElement(
          'div',
          { className: 'acuity-calendar' },
          r.a.createElement(
            pn,
            {
              firstDay: a,
      ...
      var vn = (function() {
        ...
        Dn = '.'.concat('acuity-calendar'),
        kn = '.'.concat('acuity-calendar', '__day-grid'),
        bn = '\n    '
          .concat(
            Dn,
            '__heatmap-header {\n        font-size: 14px;\n    }\n    '
      ...
      var Sn = function(e) {
        ...
        return r.a.createElement(
          a.Fragment,
          null,
          r.a.createElement('style', null, bn),
      ...
      var En = function(e) {
        var t = e.renderCell,
          ...
          a = e.firstDay,
          s = e.totalDays,
          i = xn(e, ['renderCell', 'renderHeader', 'firstDay', 'totalDays']),
          o = {
            firstDate: d()().day(a),
            lastDate: d()()
              .day(a)
